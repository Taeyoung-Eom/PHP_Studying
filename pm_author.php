...
<html>
    ...
    <body>
        ...
        <p><a href="pm_index.php">topic</a></p>
        <table border="1" >
            <tr>
                <td>id</td>
                <td>name</td>
                ...
                <tr>
                    ...
                    <td> <a href="pm_author.php?id=<?=$filtered['id']?>">update</a> </td>
                    <td>
                        <form action="pm_process_delete_author.php" method="post" onsubmit="if(!confirm('sure?')){return false;}">
    ...
    $form_action = 'pm_process_create_author.php';
    $form_id = '';
    if(isset($_GET['id'])){
        ...
        $form_action = 'pm_process_update_author.php';
